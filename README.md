...
**Data Analysis with Python Projects** — 5 projects required for certification:

- [ ] Mean-Variance-Standard Deviation Calculator
- [ ] Demographic Data Analyzer
- [x] Medical Data Visualizer ← *this project*
- [ ] Page View Time Series Visualizer
- [ ] Sea Level Predictor

> Completed prerequisites: **Data Analysis with Python** (28/28) and **Numpy** (9/9)
...
The dataset `medical_examination.csv` was downloaded from the official freeCodeCamp boilerplate repository:

```
https://github.com/freeCodeCamp/boilerplate-medical-data-visualizer
```

> ⚠️ Make sure to download the **raw** CSV file, not the GitHub webpage.
> Use the following command to download it correctly:
...
9. Calculated the **correlation matrix**.
...
| File | Description |
|---|---|
| `catplot.png` | Categorical bar chart of health variables split by cardiovascular disease |
| `heatmap.png` | Correlation heatmap of all medical features |
